    ...
    return (
        <div className="container mx-auto px-4">
            ...
            <ReactPaginate
                ...
                previousClassName={'bg-white border border-gray-300 text-gray-500 hover:bg-gray-50 relative inline-flex items-center px-4 py-2 text-sm font-medium'}
                previousLinkClassName={'page-link'}
                nextClassName={'bg-white border border-gray-300 text-gray-500 hover:bg-gray-50 relative inline-flex items-center px-4 py-2 text-sm font-medium'}
