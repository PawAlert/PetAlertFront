    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <p className="mb-2"><strong>Location:</strong> {activity.location.street}, {activity.location.district}, {activity.location.city}, {activity.location.province}</p>
                <p className="mb-2"><strong>Address Detail:</strong> {activity.location.addressDetail}</p>
