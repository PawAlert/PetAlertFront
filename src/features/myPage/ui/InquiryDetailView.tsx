    ...
    return (
        <div className="max-w-2xl mx-auto mt-8 p-6 bg-white rounded-lg shadow-md">
            ...
            <div className="space-y-4">
                <p><span className="font-semibold">유형:</span> {inquiry.type}</p>
                <p><span className="font-semibold">이름:</span> {inquiry.name}</p>
                <p><span className="font-semibold">이메일:</span> {inquiry.email}</p>
                <p><span className="font-semibold">전화번호:</span> {inquiry.phoneNumber}</p>
                <div>
